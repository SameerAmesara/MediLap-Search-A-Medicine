<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="S_SignUp.aspx.cs" Inherits="MedilapFinal.S_SignUp" %>
                ...
                <div class="col-lg-10">
                    ...
                    <div class="contact-us-box">
                        <center>
								...
								<h3 class="title">Medical Store SignUp</h3>
							</center>
                        <br />
                        <form action="#">
                            <div class="row no-gutters">
                                <div class="col-lg-12">
                                    <div class="input-box mt-10">
                                        <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" placeholder="Medical Store Name" ForeColor="White"></asp:TextBox>
                                    </div>
                                </div>
                                <br />
                                <br />
                                ...
                                <div class="col-lg-6">
                                    <div class="input-box mt-10">
                                        <asp:TextBox class="form-control" ID="TextBox8" runat="server" placeholder="Store ID"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="input-box mt-10">
