<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="U_MapMedicine.aspx.cs" Inherits="MedilapFinal.U_MapMedicine" %>
                  ...
                  <div class="card-body">
                     ...
                     <div class="row">
                        ...
                        <div class="col-lg-6">
                           <center>
                              <div class="input-box mt-10">
                                 <asp:Label ID="Label6" style="font-size:13px" CssClass="form-control" runat="server"></asp:Label>
                              </div>
                           </center>
                        </div>
                     </div>
                  ...
                  <div class="card-body">
                     <div class="row">
                        <div class="col-lg-9">
                           <center>
                              <div class="input-box">
                                 <asp:TextBox CSSclass="form-control" ID="TextBox2" runat="server" placeholder="Quantity of Medicine" ></asp:TextBox>
                              </div>
                           </center>
                        </div>
                        <div class="col-lg-3">
                           <center>
                              <div class="form-group">
                                 <asp:LinkButton  CSSclass="main-btn btn-block" ID="LinkButton2" runat="server" OnClick="LinkButton2_Click" >Pre-Book</asp:LinkButton>
                              </div>
                           </center>
                        </div>
                     </div>
