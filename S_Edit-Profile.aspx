<%@ Page Title="" Language="C#" MasterPageFile="~/Store.Master" AutoEventWireup="true" CodeBehind="S_Edit-Profile.aspx.cs" Inherits="MedilapFinal.S_Edit_Profile" %>
    ...
    <div class="row no-gutters">
        <div class="col-lg-12">
            <div class="input-box mt-10">
                <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" placeholder="Medical Store Name"></asp:TextBox>
            </div>
        </div>
    </div>
