...
{
    public partial class A_User_Management : System.Web.UI.Page
    {
        ...
        bool checkIfMemberExists()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT * from MemberInfo where M_uid='" + TextBox1.Text.Trim() + "';", con);
        ...
        void deleteMemberByID()
        {
            if (checkIfMemberExists())
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("DELETE from MemberInfo WHERE M_uid='" + TextBox1.Text.Trim() + "'", con);
        ...
        void updateMemberStatusByID(string status)
        {
            if (checkIfMemberExists())
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("UPDATE MemberInfo SET ac_stat='" + status + "' WHERE M_uid='" + TextBox1.Text.Trim() + "'", con);
                    cmd.ExecuteNonQuery();
                    con.Close();
